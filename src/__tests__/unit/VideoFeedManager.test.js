...
describe("VideoFeedManager", () => {
  ...
  describe("when `prepareVideoItemURLs` isn't run", () => {
  ...
  describe("when `prepareVideoItemURLs` is run with mock data", () => {
    it("should display a video item feed with 1 element`", function() {
      let myFeedManager = videoFeedManager();
      myFeedManager.instance().prepareVideoItemURLs(items);
