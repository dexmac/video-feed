...
class VideoSourceSelect extends Component {
    ...
    render() {
        const selectedValues = this.state.selectedSources.map((source) => source.value);
        ...
        return (
            <Select
                ...
                options={[
                    { value: constants.URL_VIDEO_SOURCE, label: constants.URL_VIDEO_SOURCE },
                    { value: constants.YOUTUBE_VIDEO_SOURCE, label: constants.YOUTUBE_VIDEO_SOURCE },
                    { value: constants.FACEBOOK_VIDEO_SOURCE, label: constants.FACEBOOK_VIDEO_SOURCE },
                ]}
            />
        );
    }
